...
public class AccessDB {
    ...
    try{			
       ...
       ResultSet rsall;
       rsall=statement.executeQuery("SELECT a.*, b.Street, b.City From Employee a left outer join Adress b on a.EmployeeID = b.EmployeeID");
       int i = 0;
       while(rsall.next()) {
    	   	arr[i][0] = rsall.getString(1);
	   		arr[i][1] = rsall.getString(2);
	    	arr[i][2] = rsall.getString(3);
	    	arr[i][3] = rsall.getString(4);
	    	arr[i][4] = rsall.getString(5);
            i++;
       }             
